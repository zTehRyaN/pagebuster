...
> **Warning**: The original repository is [https://github.com/revng/pagebuster](https://github.com/revng/pagebuster) and this is a local fork. The project has advanced significantly since then, but initially it was not published (neither code nor blogpost) due to company NDAs.
...
For more information, please refer to our [blogpost](https://rev.ng/blog/pagebuster).
